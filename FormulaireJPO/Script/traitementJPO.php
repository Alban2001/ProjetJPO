...
<html>
	...
	<body>
		<div id="header">
			<img class="image_logo_lycee" src="../Images/Logo_Lycee_Cassin.png" title="Lycée René Cassin" />
			<div class="titreHeader"><h1><i>Journée Portes Ouvertes<br/>Lycée des métiers René Cassin</i></h1></div>
		</div>
		<br/><br/><br/><br/>
...
<div id="boutonFJPO2">
	<a href="/FormulaireJPO/index.html"><input class="bouton_validerForm" name="boutonPrecedent" type="submit" value="Revenir à la page précédente" /></a>

<form method="post" action="../Script/pageFinal.php">
